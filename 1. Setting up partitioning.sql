...
ALTER DATABASE CURRENT ADD FILE (
        ...
        FILENAME='D:\Stuff\File_START.ndf'
    ) TO FILEGROUP [Filegroup_START];

ALTER DATABASE CURRENT ADD FILE (
        NAME='File_2018.ndf',
        SIZE=256MB, FILEGROWTH=256MB,
        FILENAME='D:\Stuff\File_2018.ndf'
    ) TO FILEGROUP [Filegroup_2018];

ALTER DATABASE CURRENT ADD FILE (
        NAME='File_2019.ndf',
        SIZE=256MB, FILEGROWTH=256MB,
        FILENAME='D:\Stuff\File_2019.ndf'
    ) TO FILEGROUP [Filegroup_2019];

ALTER DATABASE CURRENT ADD FILE (
        NAME='File_2020.ndf',
        SIZE=256MB, FILEGROWTH=256MB,
        FILENAME='D:\Stuff\File_2020.ndf'
    ) TO FILEGROUP [Filegroup_2020];

ALTER DATABASE CURRENT ADD FILE (
        NAME='File_2021.ndf',
        SIZE=256MB, FILEGROWTH=256MB,
        FILENAME='D:\Stuff\File_2021.ndf'
    ) TO FILEGROUP [Filegroup_2021];

ALTER DATABASE CURRENT ADD FILE (
        NAME='File_2022.ndf',
        SIZE=256MB, FILEGROWTH=256MB,
        FILENAME='D:\Stuff\File_2022.ndf'
    ) TO FILEGROUP [Filegroup_2022];

ALTER DATABASE CURRENT ADD FILE (
        NAME='File_2023.ndf',
        SIZE=256MB, FILEGROWTH=256MB,
        FILENAME='D:\Stuff\File_2023.ndf'
