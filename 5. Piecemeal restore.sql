...
BACKUP DATABASE [Partitioning Zero to Hero]
    ...
    TO DISK='D:\Stuff\Readonly_filegroups.bak'
...
--  FILEGROUP='Filegroup_2020',
    ...
    TO DISK='D:\Stuff\Full_filegroups.bak'
    WITH COMPRESSION, FORMAT;
...
RESTORE DATABASE [Partitioning Zero to Hero_restored]
    ...
    WITH RECOVERY,
         FILE = 1,
         MOVE N'File_2021.ndf' TO N'D:\Stuff\Restored_2021.ndf',
         MOVE N'File_2022.ndf' TO N'D:\Stuff\Restored_2022.ndf',
         NOUNLOAD;
...
RESTORE DATABASE [Partitioning Zero to Hero_restored]
    ...
    WITH RECOVERY,
         FILE = 1,
         MOVE N'File_2023.ndf' TO N'D:\Stuff\Restored_2023.ndf',
         MOVE N'File_2024.ndf' TO N'D:\Stuff\Restored_2024.ndf',
         MOVE N'Some_file.ndf' TO N'D:\Stuff\Restored_something.ndf',
         NOUNLOAD;
...
RESTORE DATABASE [Partitioning Zero to Hero_restored]
    ...
    FILEGROUP='Filegroup_2019',
    FILEGROUP='Filegroup_2020'
    FROM DISK = N'D:\Stuff\Readonly_filegroups.bak'
    WITH RECOVERY,
         FILE = 1,
         MOVE N'File_START.ndf' TO N'D:\Stuff\Restored_START.ndf',
         MOVE N'File_2019.ndf' TO N'D:\Stuff\Restored_2019.ndf',
         MOVE N'File_2020.ndf' TO N'D:\Stuff\Restored_2020.ndf',
         NOUNLOAD;
